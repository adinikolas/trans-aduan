        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Penanganan aduan terkait pembayaran, tarif, dan transaksi.
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-5">
                <div class="flex items-start gap-4">
                    <div class="p-3 bg-blue-100 dark:bg-blue-900/40 rounded-full text-xl">
                        💰
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700 dark:text-blue-400 mt-1">
                            ...
                            didisposisikan ke Divisi Keuangan.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                >
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="submit"
                            class="w-full sm:w-auto px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-md shadow-sm transition"
                        >
                            Terapkan
                        </button>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        ...
                                        <a
                                            ...
                                            class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 font-semibold transition"
                                        >
                                            Lihat Detail →
                                        </a>

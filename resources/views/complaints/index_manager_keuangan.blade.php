<x-app-layout>
    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm sm:text-base text-slate-500 dark:text-slate-400">
                Kelola dan tindak lanjuti aduan yang ditangani Divisi Keuangan.
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8 sm:py-10 lg:py-12">
        ...
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-blue-500/30 bg-blue-950/20 p-5 sm:p-6">

                <div class="flex items-start gap-4">

                    <div
                        class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-500/15 text-xl"
                    >
                        💰
                    </div>
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 text-sm leading-6 text-blue-200/70">
                            Menampilkan aduan yang telah didisposisikan
                            ke Divisi Keuangan untuk ditindaklanjuti.
                        </p>
                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-xl border border-slate-700 bg-slate-950/70 px-4 py-3 text-sm text-slate-200 placeholder-slate-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                        >
                    ...
                    <div>
                        ...
                        <select
                            name="status"
                            id="status"
                            class="w-full rounded-xl border border-slate-700 bg-slate-950/70 px-4 py-3 text-sm text-slate-200 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                        >
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-700/80 bg-slate-800/90 shadow-sm">
                ...
                <div class="border-b border-slate-700/80 px-5 py-5 sm:px-6">
                    ...
                    <h3 class="text-lg sm:text-xl font-bold text-white">
                        Daftar Aduan Keuangan
                    </h3>

                    <p class="mt-1 text-sm text-slate-400">
                        Aduan yang sedang ditangani oleh Divisi Keuangan.
                    </p>
                                ...
                                <tr class="transition hover:bg-slate-700/25">
                                    ...
                                    <td class="whitespace-nowrap px-5 py-5 text-center">
                                        ...
                                        <a
                                            ...
                                            class="inline-flex items-center gap-2 rounded-xl border border-slate-600 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-blue-400/50 hover:bg-blue-500/10 hover:text-blue-300"
                                        >
                                            Lihat Detail
                                            <span>→</span>
                                        </a>

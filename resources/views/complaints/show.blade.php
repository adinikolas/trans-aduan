    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 flex flex-col md:flex-row gap-6">
            ...
            <div class="w-full md:w-2/3 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-4">
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-2">Foto Bukti Pelapor:</p>
                ...
                <div class="mt-8 border-t dark:border-gray-700 pt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <a href="{{ asset('storage/proofs/' . $complaint->resolution_proof) }}" target="_blank" class="block">
                            <img src="{{ asset('storage/proofs/' . $complaint->resolution_proof) }}" alt="Bukti Perbaikan" class="max-w-full h-auto rounded border dark:border-gray-700 shadow-sm hover:opacity-90 transition">
                        </a>
